...
def Inception_ResNet_A(x, scale=0.1):   
  ...
  branch_3 = Conv2D(filters = 48, kernel_size = (3, 3), padding='same', strides=1)(branch_3)
  branch_3 = Conv2D(filters = 64, kernel_size = (3, 3), padding='same', strides=1)(branch_3)
        
  branches = concatenate([branch_1, branch_2, branch_3], axis = 3)
  Inception = Conv2D(filters = 384, kernel_size = (1, 1), padding='same', strides=1, activation = None)(branches)
...
def Inception_ResNet_B(x, scale=0.1):
  ...
  branch_2 = Conv2D(filters = 160, kernel_size = (1, 7), padding='same', strides=1)(branch_2)
  branch_2 = Conv2D(filters = 192, kernel_size = (7, 1), padding='same', strides=1)(branch_2)
        
  branches = concatenate([branch_1, branch_2])
  Inception = Conv2D(filters = 1152, kernel_size = (1, 1), padding='same', strides=1, activation = None)(branches)
...
def Inception_ResNet_C(x, scale=0.1):    
  ...
  branch_2 = Conv2D(filters = 224, kernel_size = (1, 3), padding='same', strides=1)(branch_2)
  branch_2 = Conv2D(filters = 256, kernel_size = (3, 1), padding='same', strides=1)(branch_2)      
        
  branches = concatenate([branch_1, branch_2])
  Inception = Conv2D(filters = 2144, kernel_size = (1, 1), padding='same', strides=1, activation = None)(branches)
...
def Reduction_B(x):
  ...
  branch_3 = Conv2D(filters = 288, kernel_size = (3, 3), padding='valid', strides=2)(branch_3)
  
  branch_4 = Conv2D(filters = 256, kernel_size = (1, 1), padding='same', strides=1)(x)
  branch_4 = Conv2D(filters = 288, kernel_size = (3, 3), padding='same', strides=1)(branch_4)
  branch_4 = Conv2D(filters = 320, kernel_size = (3, 3), padding='valid', strides=2)(branch_4)
...
# 두 개의 입력층을 정의
    ...
    model.save('/gdrive/My Drive/Colab/대개론_CNN/googlenet_res_v2_epochs100_not_rescale.model')
